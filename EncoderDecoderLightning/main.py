...
from EncoderDecoderLightning.datamodule import GeneratorDataModule
from EncoderDecoderLightning.model import GeneratorModule
...
def main() -> None:
    ...
    cli = CLI(GeneratorModule, GeneratorDataModule)
    print("Configuration: \n", cli.config)
